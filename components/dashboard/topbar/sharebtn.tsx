...
import {createAllBrainShareLinkHashContent} from "@/app/actions/content";
    ...
    <Dialog>
      <form>
        <DialogTrigger asChild>
          <Button
            variant="outline"
            className="bg-blue-100 text-blue-600 font-normal flex items-center hover:bg-blue-50 hover:text-blue-600"
